...
- [**whiskers**](https://github.com/catppuccin/whiskers/) Templating tool for the catppuccin color scheme in rust. In this bucket for now because it isn't popular enough for `main` bucket.
